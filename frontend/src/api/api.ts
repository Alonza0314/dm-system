...
export interface SettingAccountRequest {
    'username': string;
    'password': string;
}
...
export const SettingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {SettingAccountRequest} settingAccountRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        settingAccount: async (settingAccountRequest: SettingAccountRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'settingAccountRequest' is not null or undefined
            assertParamExists('settingAccount', 'settingAccountRequest', settingAccountRequest)
            const localVarPath = `/api/setting/account`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(settingAccountRequest, localVarRequestOptions, configuration)
...
export const SettingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async settingAccount(settingAccountRequest: SettingAccountRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.settingAccount(settingAccountRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingApi.settingAccount']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const SettingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        settingAccount(settingAccountRequest: SettingAccountRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.settingAccount(settingAccountRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SettingApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public settingAccount(settingAccountRequest: SettingAccountRequest, options?: RawAxiosRequestConfig) {
        return SettingApiFp(this.configuration).settingAccount(settingAccountRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
